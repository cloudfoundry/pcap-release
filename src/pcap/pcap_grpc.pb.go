...
const (
	API_Status_FullMethodName  = "/pcap.API/Status"
	API_Capture_FullMethodName = "/pcap.API/Capture"
)
...
func (c *aPIClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, API_Status_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aPIClient) Capture(ctx context.Context, opts ...grpc.CallOption) (API_CaptureClient, error) {
	stream, err := c.cc.NewStream(ctx, &API_ServiceDesc.Streams[0], API_Capture_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func _API_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: API_Status_FullMethodName,
	}
...
const (
	Agent_Status_FullMethodName  = "/pcap.Agent/Status"
	Agent_Capture_FullMethodName = "/pcap.Agent/Capture"
)
...
func (c *agentClient) Status(ctx context.Context, in *StatusRequest, opts ...grpc.CallOption) (*StatusResponse, error) {
	out := new(StatusResponse)
	err := c.cc.Invoke(ctx, Agent_Status_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *agentClient) Capture(ctx context.Context, opts ...grpc.CallOption) (Agent_CaptureClient, error) {
	stream, err := c.cc.NewStream(ctx, &Agent_ServiceDesc.Streams[0], Agent_Capture_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
